...
class SignatureScorer:
    ...
    def score(self, adata: anndata.AnnData) -> None:
        """
        Adds the score for the cell cycle and each signature in the scoring dict to
        adata. Furthermore, adds the `phase` of the cell cycle for each cell.
        Args:
