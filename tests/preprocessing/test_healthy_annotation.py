...
from cansig._preprocessing._malignant_annotation import (
    _get_cluster_ward,
    _get_cluster_leiden,
    _get_malignant,
...
def adata():
    ...
    adata.obs[_CONSTANTS.MALIGNANT_ANNOTATION] = (
        [_CELL_STATUS.NON_MALIGNANT] * 48
        + [_CELL_STATUS.UNDECIDED] * 2
        + [_CELL_STATUS.MALIGNANT] * 48
        + [_CELL_STATUS.UNDECIDED] * 2
    )
    return adata
...
class TestMalignantAnnotation:
    def test_malignant_annotation(self, adata):
        ...
        expected_malignant = (
            [_CELL_STATUS.NON_MALIGNANT] * 48 + [_CELL_STATUS.UNDECIDED] * 2 + [_CELL_STATUS.MALIGNANT] * 50
        )
    ...
    @pytest.mark.parametrize(
        ...
        [
            (_CELL_STATUS.MALIGNANT, _CELL_STATUS.MALIGNANT, _CELL_STATUS.MALIGNANT),
            (_CELL_STATUS.MALIGNANT, _CELL_STATUS.UNDECIDED, _CELL_STATUS.MALIGNANT),
            (_CELL_STATUS.MALIGNANT, _CELL_STATUS.NON_MALIGNANT, _CELL_STATUS.UNDECIDED),
            (_CELL_STATUS.NON_MALIGNANT, _CELL_STATUS.MALIGNANT, _CELL_STATUS.UNDECIDED),
            (_CELL_STATUS.NON_MALIGNANT, _CELL_STATUS.NON_MALIGNANT, _CELL_STATUS.NON_MALIGNANT),
            (_CELL_STATUS.NON_MALIGNANT, _CELL_STATUS.UNDECIDED, _CELL_STATUS.UNDECIDED),
        ],
    )
